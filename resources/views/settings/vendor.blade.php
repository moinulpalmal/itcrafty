                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('settings.product.vendor.setup')}}">Vendor List</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 no-padding">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="Degree" maxlength="200" class="form-control" placeholder="Enter Vendor Name" name="name" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-8 no-padding">
                                                    <div class="form-group">
                                                        <label for="FactShortName" class="">Vendor Address</label>
                                                        <input type="text" id="FactShortName" maxlength="255" class="form-control" placeholder="Enter Address" name="address" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 no-padding">
                                                    <div class=" form-group">
                                                        <label for="University2" class="">Email Address</label>
                                                        <input type="email" id="University2" maxlength="150" class="form-control" placeholder="xyz@gamil.com" name="email">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <table id="social-media-table" class="table table-responsive table-striped table-bordered table-condensed social-media table-info">
                                        <thead>
                                            <tr>
...
@section('pageScripts')
    ...
    <script>
        ...
        $(function(){
            ...
            $('#WorkExperienceForm').submit(function(e){
               ...
               /* for ( instance in CKEDITOR.instances ) {
                ...
                var url = '{{ route('settings.product.vendor.setup.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#social-media-table').on('click',".DeleteWorkExp", function(){
            ...
            var url = '{{ route('settings.product.vendor.setup.delete') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#social-media-table').on('click',".DeActivateWorkExp", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('settings.product.vendor.setup.de-activate') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#social-media-table').on('click',".ActivateWorkExp", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('settings.product.vendor.setup.activate') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#social-media-table').on('click',".EditWorkExp", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('settings.product.vendor.setup.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: id, _token: '{{csrf_token()}}'},
