                            ...
                            <div class="col-md-12" >
                                <div class="form-group" >
                                    ...
                                    <textarea id="ReqEmailDescription" rows="15" class="form-control" name="warranty_email_description" placeholder="Write Description....">
                                        ...
                                        <p>
                                            <strong>Product Category:</strong> {{$service_warranty_check->product_category}}<br>
                                            <strong>Product Sub-Category:</strong> {{$service_warranty_check->product_sub_category}}<br>
                                            <strong>Manufacturer:</strong> {{$service_warranty_check->manufacturer}}<br>
                                            <strong>Product Name:</strong> {{$service_warranty_check->product_name}}<br>
                                            <strong>Product Sl No:</strong> {{$service_warranty_check->sl_no}}<br>
                                            <strong>Problem Description:</strong> {!! $service_warranty_check->description !!}<br>
                                        </p>
                                    </textarea>
                                </div>
                            </div>
