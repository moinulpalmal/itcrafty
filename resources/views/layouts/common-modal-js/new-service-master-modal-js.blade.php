<script>
    $(document).ready(function () {
       ...
       // getDepartmentList();
        ...
        $("#NewDesignation").on('show.bs.modal', function (e) {
            $("#NewCustomer").modal("hide");
        });

        $("#NewManufacturer").on('show.bs.modal', function (e) {
            $("#NewProductMaster").modal("hide");
        });

        $('#NewManufacturer').on('hidden.bs.modal', function () {
            $('#NewProductMaster').modal('show')
        })
    });
        ...
        if(check){
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('select[id= "NewCustomerFactory"]').empty();

                    $('select[id= "Factory"]').append('<option value="'+ defaultKey +'">'+ defaultValue +'</option>');
                    $('select[id= "NewCustomerFactory"]').append('<option value="'+ defaultKey +'">'+ defaultValue +'</option>');
                    $.each(data, function(key,value){
                        //console.log(data);
                        $('select[id= "Factory"]').append('<option value="'+ value +'">'+ key +'</option>');
                        $('select[id= "NewCustomerFactory"]').append('<option value="'+ value +'">'+ key +'</option>');
                    });
        ...
        if(check){
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('select[id= "NewCustomerDepartment"]').empty();
                    $('select[id= "Department"]').append('<option value="'+ defaultKey +'">'+ defaultValue +'</option>');
                    $('select[id= "NewCustomerDepartment"]').append('<option value="'+ defaultKey +'">'+ defaultValue +'</option>');
                    $.each(data, function(key,value){
                        //console.log(data);
                        $('select[id= "Department"]').append('<option value="'+ value +'">'+ key +'</option>');
                        $('select[id= "NewCustomerDepartment"]').append('<option value="'+ value +'">'+ key +'</option>');
                    });
                    //$('#YarnCountName').trigger('chosen:updated');
                    resetSelect2();
                }
