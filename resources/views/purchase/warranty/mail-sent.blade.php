                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('purchase.warranty.mail-sent')}}">Warranty Mail Sent</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Warranty Mail Sent</h4>
                                    ...
                                    <table id="social-media-table" class="table table-striped table-responsive-lg table-bordered table-condensed social-media table-info">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Mailed At</th>
                                            ...
                                            @foreach($products as $media)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        {{\Carbon\Carbon::parse($media->mailed_at)->format('j-M-Y')}}
                                                    </td>
                                                    <td class="text-center">
                                                        {{\App\View_Model\EmailList::ageInDays($media->mailed_at)}}
                                                    </td>
                                                    <td class="text-center">
