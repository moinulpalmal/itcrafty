                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('purchase.warranty.requested')}}">Warranty Requested</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Warranty Requested</h4>
                                        ...
                                        @if(!empty($products))
                                            ...
                                            @foreach($products as $media)
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                       {{\Carbon\Carbon::parse($media->generated_at)->format('j-M-Y')}}
                                                    </td>
                                                    <td class="text-center">
                                                        {{\App\View_Model\EmailList::ageInDays($media->generated_at)}}
                                                    </td>
                                                    <td class="text-center">
                                                        <a class="btn btn-danger btn-sm btn-round fa fa-times CancelWorkExp" data-id="{{$media->id}}" title="Cancel Warranty Request"></a>
...
@section('pageScripts')
    ...
    <script>
        ...
        $('#social-media-table').on('click',".CancelWorkExp", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('purchase.warranty.detail.cancel-request') }}';
            swal({
                title: 'Are you sure?',
                text: 'This warranty request will be canceled!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
