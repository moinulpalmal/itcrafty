                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('purchase.warranty.canceled')}}">Warranty Canceled</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Warranty Canceled</h4>
                                        ...
                                        @if(!empty($products))
                                            ...
                                            @foreach($products as $media)
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                       {{\Carbon\Carbon::parse($media->delivered_at)->format('j-M-Y')}}
                                                    </td>
                                                    <td class="text-center">
                                                        {{\App\View_Model\EmailList::ageInDays($media->delivered_at)}}
                                                    </td>
                                                    <td class="text-center">
